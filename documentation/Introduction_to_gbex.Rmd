...
author: "Clément Dombry and Jasper Velthoen"
date: "10/18/2019"
output: pdf_document
---
...
sf=0.1 # The subsample fraction used for estimating each tree (in a single step only one subsample is drawn and used for both the sigma and gamma tree)
```
